...
| M7 | Polish: settings UI for the remaining settings.json keys, backup/restore, auto-update, "take over" of a session open elsewhere, settings sync; later executors (GitHub issues, calendar, weekly digest) | Daily-driver quality |
